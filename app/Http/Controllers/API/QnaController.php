...
class QnaController extends Controller
{
    ...
    {
        $events = QnA::where([['created_by_id', auth('sanctum')->user()->id], ['status', '<', 1]]);
    ...
    {
        $approved = QnA::where([['created_by_id', auth('sanctum')->user()->id], ['status', 1]])->count();
        $pending = QnA::where([['created_by_id', auth('sanctum')->user()->id], ['status', 0]])->count();
    ...
    {
        $events = QnA::where([['created_by_id', auth('sanctum')->user()->id], ['status', 9]]);
