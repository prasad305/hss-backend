        ...
        <div class="container-fluid">
            <div class="card card-bg head-line mt-4 mb-2 mt-4 mb-2">
                <div class="text-light d-flex p-2">
                    <h4 class="mx-3 text-white p-2">Audition Admin</h4>
                </div>
            </div>
                                    ...
                                    <td style="width: 150px">
                                        @if ($admin->status == 0)
                                            <button class="btn btn-sm btn-success" onclick="activeNow(this)"
                                                value="{{ route('superAdmin.auditionAdmin.activeNow', $admin->id) }}">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </button>
                                        @elseif($admin->status == 1)
                                            <button class="btn btn-sm btn-danger" onclick="inactiveNow(this)"
                                                value="{{ route('superAdmin.auditionAdmin.inactiveNow', $admin->id) }}">
