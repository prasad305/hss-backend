                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 150px">
                            @if ($admin->status == 0)
                                <button class="btn btn-success" onclick="activeNow(this)" value="{{ route('superAdmin.star.activeNow', $admin->id) }}">
                                    <i class="fa fa-check" aria-hidden="true"></i>
                                </button>
                            @elseif($admin->status == 1)
                                <button class="btn btn-danger" onclick="inactiveNow(this)" value="{{ route('superAdmin.star.inactiveNow', $admin->id) }}">
