        ...
        <div class="container-fluid">
            <div class="card card-bg head-line mt-4 mb-2">
                <div class="text-light d-flex p-2">
                    <h4 class="mx-3 text-white p-2">Country List</h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-success btn-sm" style="float: right;"
                        onclick="Show('New Country','{{ route('superAdmin.country.create') }}')"><i
                            class=" fa fa-plus"></i>&nbsp;New Country</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                    ...
                                    <td style="width: 150px">
                                        ...
                                        @if ($data->status == 0)
                                            <button class="btn btn-success" onclick="activeNow(this)"
                                                value="{{ route('superAdmin.country.activeNow', $data->id) }}">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </button>
                                        @elseif($data->status == 1)
                                            <button class="btn btn-danger" onclick="inactiveNow(this)"
                                                value="{{ route('superAdmin.country.inactiveNow', $data->id) }}">
