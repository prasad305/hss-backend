            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-success btn-sm" style="float: right;"
                        onclick="Show('New Currency','{{ route('superAdmin.currency.create') }}')"><i
                            class=" fa fa-plus"></i>&nbsp;New Currency</a>
                    ...
                    <button class="btn btn-info btn-sm mr-3" style="float: right;" onclick="currencyChanges(this)"
                        value="{{ route('superAdmin.currency.currencyChanges') }}">
                                    ...
                                    <td style="width: 150px">
                                        @if ($currency->status == 0)
                                            <button class="btn btn-success" onclick="activeNow(this)"
                                                value="{{ route('superAdmin.currency.activeNow', $currency->id) }}">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </button>
                                        @elseif($currency->status == 1)
                                            <button class="btn btn-danger" onclick="inactiveNow(this)"
                                                value="{{ route('superAdmin.currency.inactiveNow', $currency->id) }}">
                                                <i class="fa fa-close"></i>
                                            </button>
                                        @endif
                                        <a class="btn btn btn-info"
                                            onclick="Show('Edit Currency','{{ route('superAdmin.currency.edit', $currency->id) }}')"><i
                                                class="fa fa-edit text-white"></i></a>
                                        <button class="btn btn-danger" onclick="delete_function(this)"
                                            value="{{ route('superAdmin.currency.destroy', $currency->id) }}">
