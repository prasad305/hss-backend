    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
              ...
              <a class="btn btn-success btn-sm" style="float: right;" onclick="Show('New Manager Admin','{{ route('superAdmin.managerAdmin.create') }}')"><i class=" fa fa-plus"></i>&nbsp;New Manager Admin</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 150px">
                            <a class="btn btn-sm btn-info" onclick="Show('Edit Manager Admin','{{ route('superAdmin.managerAdmin.edit', $data->id) }}')"><i class="fa fa-edit text-white"></i></a>
                            <button class="btn btn-danger" onclick="delete_function(this)" value="{{ route('superAdmin.managerAdmin.destroy', $data) }}"><i class="fa fa-trash"></i> </button>
                        </td>
                    </tr>
                    @endforeach
