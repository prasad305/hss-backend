                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <img class="direct-chat-img"
                                                src="{{ asset('assets/manager-admin/dist/img/user1-128x128.jpg') }}"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img"
                                                src="{{ asset('assets/manager-admin/dist/img/user3-128x128.jpg') }}"
                                                alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/manager-admin/dist/img/user7-128x128.jpg') }}"
                                                        alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/manager-admin/dist/img/user5-128x128.jpg') }}"
                                                        alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/manager-admin/dist/img/user6-128x128.jpg') }}"
                                                        alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ asset('assets/manager-admin/dist/img/user8-128x128.jpg') }}"
                                                        alt="User Avatar">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <ul class="users-list clearfix">
                                        ...
                                        <li>
                                            <img src="{{ asset('assets/manager-admin/dist/img/user7-128x128.jpg') }}"
                                                alt="User Image">
                                            <a class="users-list-name" href="#">Jane</a>
                                            <span class="users-list-date">12 Jan</span>
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/manager-admin/dist/img/user6-128x128.jpg') }}"
                                                alt="User Image">
                                        ...
                                        <li>
                                            <img src="{{ asset('assets/manager-admin/dist/img/user5-128x128.jpg') }}"
                                                alt="User Image">
                                            <a class="users-list-name" href="#">Sarah</a>
                                            <span class="users-list-date">14 Jan</span>
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/manager-admin/dist/img/user4-128x128.jpg') }}"
                                                alt="User Image">
                            ...
                            <ul class="products-list product-list-in-card pl-2 pr-2">
                                <li class="item">
                                    <div class="product-img">
                                        <img src="{{ asset('assets/manager-admin/dist/img/default-150x150.png') }}"
