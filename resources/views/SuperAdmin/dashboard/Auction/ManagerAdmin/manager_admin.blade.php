            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('superAdmin.auctionEvents.dashboard') }}">Home</a>
                        </li>
                        ...
                        <div class="info-box mb-3 text-center border border-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-text">{{ $user->first_name }}
                                    {{ $user->last_name }}</span>
                                <span class="info-box-number">{{ $user->category->auction->count() }}</span>
                                <span class="info-box-number">
                                    <small><a class="text-warning"
                                            href="{{ route('superAdmin.auctionEvents.managerAdminEvents', $user->category->id) }}">See
                                            All</a></small>
                                </span>
                            </div>
                        </div>
