        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Audition Events</h3>
                    <a class="btn btn-success btn-sm" style="float: right;"
                        href="{{ route('superAdmin.auditionEvents.dashboard') }}"><i class=" fa fa-arrow"></i>&nbsp;Go
                        Back</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($postList as $key => $post)
                                <tr>
                                    ...
                                    <td>{{ $post->title }}</td>
                                    <td>{{ $post->auditionAdmin->first_name }} {{ $post->auditionAdmin->last_name }}</td>
                                    <td>
                                        @foreach ($post->assignedJudges as $judge)
                                            {{ $judge->user->first_name }}{{ $judge->user->last_name }} <br />
                                        @endforeach
                                    </td>
                                    <td>
                                        @if ($post->status == 2)
