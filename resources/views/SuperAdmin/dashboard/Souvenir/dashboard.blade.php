                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.souvenirEvents.souvenirDataList', 'total') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.souvenirEvents.souvenirDataList', 'rejected') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.souvenirEvents.managerAdminList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.souvenirEvents.adminList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.souvenirEvents.superstarList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
