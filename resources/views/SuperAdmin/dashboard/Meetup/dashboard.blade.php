...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Meetup Dashboard</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.meetupEvents.meetupDataList', 'total') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.meetupEvents.meetupDataList', 'pending') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.meetupEvents.meetupDataList', 'published') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.meetupEvents.meetupDataList', 'rejected') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.meetupEvents.managerAdminList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.meetupEvents.adminList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.meetupEvents.superstarList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
