...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Learning Session Dashboard</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3 text-center border border-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $category->learning_session_count }}</span>
                                <span class="info-box-number">
                                    <small><a class="text-warning"
                                            href="{{ route('superAdmin.learningSession.list', $category->id) }}">See
                                            All</a></small>
                                </span>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.learningSessionEvents.learningSessionDataList', 'total') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.learningSessionEvents.learningSessionDataList', 'pending') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.learningSessionEvents.learningSessionDataList', 'published') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.learningSessionEvents.learningSessionDataList', 'rejected') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.learningSessionEvents.managerAdminList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.learningSessionEvents.adminList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.learningSessionEvents.superstarList') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
