...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Live Chat Events</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Live Chat Events</h3>
                    <a class="btn btn-success btn-sm" style="float: right;"
                        href="{{ route('superAdmin.liveChatEvents.dashboard') }}"><i class=" fa fa-arrow"></i>&nbsp;Go
                        Back</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        ...
                                        <a class="btn btn-sm btn-info"
                                            onclick="Show('Edit Post','{{ route('superAdmin.liveChat.edit', $post->id) }}')"><i
