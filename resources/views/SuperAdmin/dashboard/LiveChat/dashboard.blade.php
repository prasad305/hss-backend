                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3 text-center border border-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $category->live_events_count }}</span>
                                <span class="info-box-number">
                                    <small><a class="text-warning"
                                            href="{{ route('superAdmin.liveChat.list', $category->id) }}">See
                                            All</a></small>
                                </span>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.liveChatEvents.liveChatDataList', 'total') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.liveChatEvents.liveChatDataList', 'pending') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.liveChatEvents.liveChatDataList', 'published') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3 text-center border border-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <small><a class="text-warning"
                                        href="{{ route('superAdmin.liveChatEvents.liveChatDataList', 'rejected') }}">See
                                        All</a></small>
                            </span>
                        </div>
                    </div>
