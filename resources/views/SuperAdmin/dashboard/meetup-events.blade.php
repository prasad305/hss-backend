...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0" style="font-size: 20px; color: gold; font-weight: 600;">Online Meetup Events</h1>
        </div><!-- /.col -->
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0" style="font-size: 20px; color: gold; font-weight: 600;">Offline Meetup Events</h1>
      </div><!-- /.col -->
