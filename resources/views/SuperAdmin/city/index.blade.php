...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">All City Lists</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <a class="btn btn-success btn-sm" style="float: right;" onclick="Show('New city','{{ route('superAdmin.city.create') }}')"><i class=" fa fa-plus"></i>&nbsp;New city</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
