<form id="edit-form" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-md-12">
        <label for="details">About Summery</label>
    ...
    <div class="form-group row">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="status" id="inlineRadio1" {{ $aboutus->status == 1 ? 'checked' : '' }} value="1">
          <label class="form-check-label" for="inlineRadio1">Active</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="status" id="inlineRadio2" {{ $aboutus->status == 0 ? 'checked' : '' }} value="0">
...
<script>
    ...
    $.ajaxSetup({
        ...
        $.ajax({
            url: "{{ route('superAdmin.aboutUs.update',$aboutus->id) }}",
            data: formData,
        processData: false,
        contentType: false,
        type: 'POST',
