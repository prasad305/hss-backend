        ...
        <div class="container-fluid">
            <div class="card card-bg head-line mt-4 mb-2">
                <div class="text-light d-flex p-2">
                    <h4 class="mx-3 text-white p-2">Souvenir Delivery Charges List</h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-success btn-sm" style="float: right;"
                        onclick="Show('New Delivery Charge','{{ route('superAdmin.souvenirdeliverycharge.create') }}')"><i
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        <a class="btn btn-sm btn-info"
                                            onclick="Show('Edit Delivery Charge','{{ route('superAdmin.souvenirdeliverycharge.edit', $data->id) }}')"><i
                                                class="fa fa-edit text-white"></i></a>
                                        @if ($data->status == 0)
                                            <button class="btn btn-success" onclick="activeNow(this)"
                                                value="{{ route('superAdmin.souvenirdeliverycharge.activeNow', $data->id) }}">
                                                <i class="fa fa-check" aria-hidden="true"></i>
                                            </button>
                                        @elseif($data->status == 1)
                                            <button class="btn btn-danger" onclick="inactiveNow(this)"
                                                value="{{ route('superAdmin.souvenirdeliverycharge.inactiveNow', $data->id) }}">
