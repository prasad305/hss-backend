...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        <a href="{{ route('superAdmin.category.index') }}" class="nav-link">
      ...
      <li class="nav-item">
        <a href="{{ route('superAdmin.subCategory.index') }}" class="nav-link">
          <i class="nav-icon fas fa-th"></i>
          <p>
            Subcategory
          </p>
      ...
      <li class="nav-item">
        <a href="{{ route('superAdmin.managerAdmin.index') }}" class="nav-link">
          <i class="nav-icon fas fa-th"></i>
          <p>
            Manager Admin
          </p>
      ...
      <li class="nav-item">
        <a href="{{ route('superAdmin.star.index') }}" class="nav-link">
          <i class="nav-icon fas fa-th"></i>
          <p>
            Super Star
          </p>
      ...
      <li class="nav-item">
        <a href="{{ route('superAdmin.greeting-type.index') }}" class="nav-link">
          <i class="nav-icon fas fa-th"></i>
          <p>
            Greeting Type
          </p>
      ...
      <li class="nav-item">
        <a href="{{ route('superAdmin.interest-type.index') }}" class="nav-link">
          <i class="nav-icon fas fa-th"></i>
          <p>
            Interest Type
          </p>
