                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        <a href="https://www.hellosuperstars.com" title="logo" target="_blank">
                                            <img width="80"
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 35px;padding-top:20px">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:2px 40px;">
                                            Your code reset code is given below. Please don't share your code with
                                            anyone.The code will be disabled within 15 minutes ,Thank you
                                        </p>
