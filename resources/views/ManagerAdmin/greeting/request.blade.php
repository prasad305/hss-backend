...
@section('content')
    ...
    <div class="row">
        @foreach ($greetings as $key => $greeting)
            <div class="col-md-4">
                <div class="card" style="width: 100%; margin: 10px; border:2px solid #FFCE00;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <a href="#" class="btn"
                                style="background: #FFCE00; border-radius: 8px; font-weight: bold;">View <i class="fas fa-eye"></i></a>
                        </div>
                    </div>
                </div>
            </div>
