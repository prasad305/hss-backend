                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="form-group mb-4">
                            <div class="form-group">
                                ...
                                <select name="user_name" id="user_name" class="custom-select rounded-0"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".sub_category_id").click(function() {
                ...
                if (subCat_id > 0) {
                    ...
                    $.ajax({
                        url: "{{ url('manager-admin/accounts-index-superstar-filter') }}" + '/' +
                            subCat_id,
                        type: 'GET',
                    ...
                    success: function(response) {
                        ...
                        if (response.module == 4) {
                            ...
                            _html +=
                                ...
                                '</h1></span></div></div> <span class="info-box-number" style="color:rgb(236, 189, 119)"><h3>' +
                                response.souvenir.title +
                                '</h3></span><span class="info-box-number"><small><input type="hidden" value="' +
                                response.module +
                                '" id="module" /><input type="hidden" value="' + response
                                .souvenir.id + '" id="viewPageIdsouvenir" /><button type="button" class="btn btn-warning btn-sm viewPagesouvenir">More Info</button></small></span> </div></div> </div>';
        ...
        $(document).on('click', '.viewPage', function(e) {
            ...
            $.ajax({
                type: 'GET',
                success: function(res) {
                    window.open("{{ url('manager-admin/superstar-accounts') }}" + '/' + viewPageId +
                        '/' + mod, "_blank");
                }
            });
        ...
        $(document).on('click', '.viewPagesouvenir', function(e) {

            // var viewId = $(this).attr("id");
            var viewPageId = $('#viewPageIdsouvenir').val();
            var mod = $('#module').val();
            $.ajax({
                type: 'GET',
                success: function(res) {
