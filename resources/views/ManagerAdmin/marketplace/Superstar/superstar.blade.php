            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('managerAdmin.dashboard.marketplace') }}">Home</a>
                        </li>
                ...
                @foreach ($superstars as $star)
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3 text-center border border-warning">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ $star->superstar->first_name }}
                                    {{ $star->superstar->last_name }}</span>
                                <span class="info-box-number">
                                    <small><a class="text-warning"
                                            href="{{ route('managerAdmin.marketplaceEvents.superstarEvents', $star->superstar->id) }}">See
                                            All</a></small>
                                </span>
                            </div>
                        </div>
