            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Meetup Dashboard</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3 text-center border border-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $category->submeetup->count() }}</span>
                                <span class="info-box-number">
                                    <small><a class="text-warning"
                                            href="{{ route('managerAdmin.submeetup.list', $category->id) }}">See
                                            All</a></small>
                                </span>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="{{ route('managerAdmin.dashboard.meetupEventData', 'total') }}">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <a href="{{ route('managerAdmin.dashboard.meetupEventData', 'complete') }}">
                                <span class="my-link"><i class="fas fa-eye"> View All </i> </span>
                            </a>
                        </div>
                        <!-- /.info-box-content -->
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    <div class="info-box border border-warning">
                        ...
                        <div class="info-box-content text-center">
                            ...
                            <a href="{{ route('managerAdmin.meetupEvents.adminList') }}">
                                <span class="my-link"><i class="fas fa-eye"> View All </i> </span>
                            </a>
                        </div>
                        <!-- /.info-box-content -->
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    <div class="info-box mb-3 border border-warning">
                        ...
                        <div class="info-box-content text-center">
                            ...
                            <a href="{{ route('managerAdmin.meetupEvents.superstarList') }}">
                                <span class="my-link"><i class="fas fa-eye"> View All </i> </span>
                            </a>
                        </div>
                        <!-- /.info-box-content -->
