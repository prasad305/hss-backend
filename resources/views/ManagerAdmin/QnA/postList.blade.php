            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-success btn-sm" style="float: right;"
                        href="{{ route('managerAdmin.dashboard.qna') }}"><i class=" fa fa-arrow"></i>&nbsp;Go
                        Back</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            @foreach ($postList as $key => $post)
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        <a href="{{ route('managerAdmin.qna.details', [$post->id]) }}"
                                            class="btn btn-sm btn-success"> <i class="fa fa-eye"></i></a>
                                        <a class="btn btn-sm btn-info"
                                            onclick="Show('Edit Post','{{ route('managerAdmin.qna.edit', $post->id) }}')"><i
                                                class="fa fa-edit text-white"></i></a>
                                        {{-- <button class="btn btn-sm btn-danger" onclick="delete_function(this)"
                                            value="{{ route('managerAdmin.qna.destroy', $post->id) }}"><i
