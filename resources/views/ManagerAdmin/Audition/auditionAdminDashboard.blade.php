    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-12">
            <div class="row info-box bg-dark shadow-none pb-4 m-3 BGa">
                <img src="{{ asset('assets/manager-admin/guitar.png') }}" alt="Admin Image"
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="row info-box bg-dark shadow-none pb-4 m-3 BGaB">
                <img src="{{ asset('assets/manager-admin/swimming.png') }}" alt="Admin Image"
                    class="img-fluid ImgBlue mr-3 mb-2">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="row info-box bg-dark shadow-none pb-4 m-3 BGaB">
                <img src="{{ asset('assets/manager-admin/football.png') }}" alt="Admin Image"
                    class="img-fluid ImgBlue mr-3 mb-2">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box bg-light shadow-none pt-4 pb-4 m-3">
                ...
                <div class="px-2 d-flex align-items-center mt-3" style="border-left: 1px solid gray">
                    <a href="">
