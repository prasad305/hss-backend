<form  id="edit-form" enctype="multipart/form-data">
    ...
    <div class="row form-group">
        <div class="col-md-12">
              ...
              <input type="text" class="form-control" id="first_name" name="title" placeholder="Enter Admin First Name" value="{{$event->title }}">
         </div>
     </div>
    ...
    <div class="row form-group">
        <div class="col-md-6">
         ...
         <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="slots" placeholder="" value="{{$event->participant_number }}">
       </div>
     </div>
