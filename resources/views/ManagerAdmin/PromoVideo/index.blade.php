        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Promo Video</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="panel panel-primary text-center">
                        ...
                        <div class="panel-body py-3">
                            ...
                            <a href="{{ route('managerAdmin.promoVideo.details', [$val->id]) }}" type="button" class="btn btn-info waves-effect waves-light">Details <i class="fa fa-angle-double-right"></i></a>
