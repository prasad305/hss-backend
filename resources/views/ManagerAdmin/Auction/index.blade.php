                ...
                <div class="card">
                    <div class="panel panel-primary text-center">
                        ...
                        <div class="panel-body py-3">
                            ...
                            <a href="{{ route('managerAdmin.auctionProduct.details', [$val->id]) }}" type="button" class="btn btn-info waves-effect waves-light">Details <i class="fa fa-angle-double-right"></i></a>
