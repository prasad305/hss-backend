                ...
                <div class="col-12 col-sm-6 col-md-12">
                    <div class="info-box text-center">
                        <div class="info-box-content">
                            <span class="info-box-text text-warning">Auction</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                @foreach ($auction as $post)
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">
                                    <small><a class="text-warning"
                                            href="{{ route('managerAdmin.auctionProduct.details', $post->id) }}">See
                                            All</a></small>
                                </span>
                                @if ($post->product_status == 0)
                                    <span class="badge badge-warning">Unsold</span>
                                @else($post->product_status == 1)
