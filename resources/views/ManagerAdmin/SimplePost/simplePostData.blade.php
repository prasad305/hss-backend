...
@section('content')
    <div class="card">
                    ...
                    <tbody>
                        ...
                        @foreach ($portalData as $key => $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('managerAdmin.dashboard.simplePostDetails', $data->id) }} "
        ...
        <div class="card-footer clearfix">
            <a href="{{ route('managerAdmin.dashboard.simplePost') }}" class="btn btn-sm btn-info float-left">Go Back</a>
