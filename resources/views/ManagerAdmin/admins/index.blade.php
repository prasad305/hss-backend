...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row float-right">
            <a class="btn btn-success btn-sm mr-4" style="float: right; margin-bottom: 10px;" onclick="Show('New Admin','{{ route('managerAdmin.admin.create') }}')"><i class=" fa fa-filter"></i>&nbsp;Filter</a>
            <a class="btn btn-success btn-sm mr-4" style="float: right; margin-bottom: 10px;" onclick="Show('New Admin','{{ route('managerAdmin.admin.create') }}')"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Search</a>
            <a class="btn btn-success btn-sm mr-4" style="float: right; margin-bottom: 10px;" onclick="Show('New Admin','{{ route('managerAdmin.admin.create') }}')"><i class=" fa fa-plus"></i>&nbsp;Add New</a>
        </div>
        ...
        @foreach ($admins as $admin)
          <div class="col-md-3 col-sm-6 col-12">
            ...
            <img src="{{ $admin->image ? asset($admin->image) : asset(get_static_option('no_image')) }}" alt="admin Image" class="img-fluid mr-3" style="height: 100px; width: 100px; border-radius: 50%;">

              <div class="px-2" style="border-left: 1px solid gray">
                <a href="{{ route('managerAdmin.admin.show', $admin->id) }}">
                    <span class="info-box-text text-white"><h4>{{ $admin->first_name }} {{ $admin->last_name }}</h4></span>
                </a>
                <p>Music</p>
