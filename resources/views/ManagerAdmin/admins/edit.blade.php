        ...
        <select name="sub_category_id" id="sub_category_id" class="form-control">
            ...
            @if (isset($sub_categories[0]))
                @foreach ($sub_categories as $key => $subCategory)
                    <option {{ $subCategory->id == $admin->sub_category_id ? 'selected' : '' }}
    ...
    <div class="row form-group">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="first_name" name="first_name"
                placeholder="Enter Audition Admin First Name" value="{{ $admin->first_name }}">
            <span class="text-danger" id="first_name_error"></span>
        </div>
        <div class="col-md-6">
            <label for="last_name">Last Name</label>
            <input type="text" class="form-control" id="last_name" name="last_name"
                placeholder="Enter Audition Admin Last Name" value="{{ $admin->last_name }}">
    ...
    <div class="form-group row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="phone" name="phone"
                placeholder="Enter Audition Admin Phone" value="{{ $admin->phone }}">
            <span class="text-danger" id="phone_error"></span>
        </div>
        <div class="col-md-6">
            <label for="email">Email</label>
            <input type="text" class="form-control" id="email" name="email"
                placeholder="Enter Audition Admin Email" value="{{ $admin->email }}">
    ...
    <div class="form-group row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="profit" name="profit"
                placeholder="Enter  Profit Share in percentage" value="{{ $admin->profitShare->profit }}">
    ...
    <span class="row">
        <div class="form-group col-md-6">
            ...
            <br><img id="image1" onchange="validateMultipleImage('image1')" alt="icon"
                src="{{ asset($admin->image) }}" height="180px" width="180px"
        ...
        <div class="form-group col-md-6">
            ...
            <br><img id="image2" onchange="validateMultipleImage('image2')" alt="icon"
                src="{{ asset($admin->cover_photo) }}" height="180px" width="180px"
                onerror="this.onerror=null;this.src='{{ asset(get_static_option('no_image')) }}';" required />
